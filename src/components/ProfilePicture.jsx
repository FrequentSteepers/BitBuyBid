      ...
      <Card style={{display: 'inline-block', width: '300px', backgroundColor: 'lightsteelblue'}}>
        {
          this.props.photo ? 
            <div style={{width: '100%', maxHeight: '100%', position: 'relative', padding: '5%'}}> 
              ...
              <img onClick={() => this.props.toggle()} style={{position: 'absolute', bottom: '20%', right: '20%', width: '10%', zIndex: '10', cursor: 'pointer', opacity: '.5'}} src={'https://f.vimeocdn.com/images_v6/professionals/icon-upload-vimeo-blue.svg'}/> 
            </div> :
